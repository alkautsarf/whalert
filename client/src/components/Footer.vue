<template>
    <div class="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 mt-96">
        <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
            <div class="sm:col-span-2">
                ...
                <div class="mt-6 lg:max-w-sm">
                    <p class="text-sm text-gray-800">
                        Gain Cutting-Edge Insights into Whale Wallet Transactions and Stay Ahead of the Game
                    </p>
                </div>
            </div>
            <div class="space-y-2 text-sm">
                ...
                <div class="flex">
                    ...
                    <a href="tel:850-123-5021" aria-label="Our phone" title="Our phone"
                        class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">+62-851-5636-6007</a>
                </div>
                <div class="flex">
                    <p class="mr-1 text-gray-800">Email:</p>
                    <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email"
                        class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">alkautsarsol22@gmail.com</a>
                </div>
                <div class="flex">
            ...
            <div>
                ...
                <p class="mt-4 text-sm text-gray-500">
                    Bismillah 2024 Bull Market
                </p>
            </div>
        </div>
        <div class="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
            <p class="text-sm text-gray-600">
                © Copyright 2023 Whalert Inc. All rights reserved.
            </p>
