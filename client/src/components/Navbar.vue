...
export default {
    ...
    computed: {
        ...mapState(useMainStore, ['username','access_token'])
    },
    methods: {
        ...
        <div class="relative flex items-center justify-between">
            <div class="flex items-center">
                <a href="/" aria-label="Company" title="Company" class="inline-flex items-center mr-8">
                    ...
                    <span class="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">Whalert</span>
                </a>
                <ul class="flex items-center hidden space-x-8 lg:flex">
                    <router-link to="/alert">
                    <li>
                        <a href="#" aria-label="Our product" title="Our product"
                            class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Alert</a>
                    </li>
                    </router-link>
                    <router-link to="/add-alert">
                    <li>
                        <a href="#" aria-label="Our product" title="Our product"
                            class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Add Alert</a>
                    </li>
                    </router-link>
                </ul>
            </div>
            <ul class="flex items-center hidden space-x-8 lg:flex" v-if="!this.access_token">
            ...
            <ul class="flex items-center hidden space-x-8 lg:flex" v-else>
                <li>
                    <h1 aria-label="Sign in" title="Sign in"
                        class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Hi, {{ this.username }}</h1>
