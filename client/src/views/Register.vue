...
//             clientId: "BATlYDxfgzB-7gtAai96n1zuaQREJ7NhryKitmSu3M5Jlw422ver9yXVylCjOfgVyiCa6lucA3NK7Qj4KpUATo8", // Get your Client ID from Web3Auth Dashboard
//             chainConfig: {
...
<template>
    <div class="flex justify-center items-center mx-auto mt-16 w-1/4 animate__animated animate__slideInLeft">
        <form @submit.prevent="register(form)"
            action="https://kitwind.us18.list-manage.com/subscribe/post?u=58a372bada5b2c977767bdf69&amp;id=055508a2ba">
            <label for="username" class="inline-block mb-2 font-semibold">
                Username
            </label>
            <input id="username" autocomplete="email" name="EMAIL" aria-required="true" placeholder="Your username" v-model="form.username"
            ...
            <input id="email" autocomplete="email" name="EMAIL" aria-required="true" placeholder="Your email" type="email" v-model="form.email"
                maxlength="150"
                class="flex-grow w-full h-12 px-4 mb-4 transition duration-200 bg-white border border-gray-400 rounded shadow-sm appearance-none focus:outline-none focus:shadow-outline focus:border-indigo-500"
                style="appearance: none;">
            <label for="password" class="inline-block mb-2 font-semibold">
                Password
            </label>
            <input id="password" autocomplete="email" name="EMAIL" aria-required="true" placeholder="Your password" v-model="form.password"
                type="password" maxlength="150"
                class="flex-grow w-full h-12 px-4 mb-4 transition duration-200 bg-white border border-gray-400 rounded shadow-sm appearance-none focus:outline-none focus:shadow-outline focus:border-indigo-500"
                style="appearance: none;">
            <div class="flex flex-col mx-auto w-2/4 text-center mt-4">
                <button type="submit"
                    class="px-2 h-12 inline-flex items-center justify-center w-full mb-4 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-indigo-600 hover:bg-indigo-700 focus:shadow-outline focus:outline-none">Register</button>
                <router-link to="/signin">
                <button type="button"
                    class="px-2 h-12 inline-flex items-center justify-center w-full mb-2 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-indigo-600 hover:bg-indigo-700 focus:shadow-outline focus:outline-none">Sign
                    In
                </button>
                </router-link>
